...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'comun.Usuario'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'comun.UsuarioPermissao'
grails.plugin.springsecurity.authority.className = 'comun.Permissao'

grails.plugin.springsecurity.auth.loginForm = '/areaRestrita/logar'
